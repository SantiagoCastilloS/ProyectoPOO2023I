...
SELECT p.id_prod, p.nombre_prod, p.descripcion_prod, p.stock_prod, p.precio_prod, d.porcentaje_desc, p.precio_prod - p.precio_prod * d.porcentaje_desc AS precio_final, v.nombre_ven, p.urlImage FROM producto p INNER JOIN descuento d ON d.id_prod = p.id_prod INNER JOIN vendedor v ON v.id_ven = p.id_ven; -- SANTIAGO (hecho)
...
-- producto
INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0001,'Samsung','Refrigerador Samsung 361L No Frost Rt35K5930S8 Plata',1950,200, 0002, 0001);
INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0002,'LG','Refrigerador LG 312L No Frost GT32WPPDC Plateado', 1900,300, 0002, 0001);
...
INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0005,'Hisense','Refrigerador Hisense 418L Top Mount', 1600,250, 0002, 0001);
INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0006,'Samsung','Refrigerador 361Lt Twin Cooling Silver', 1900,200, 0002, 0001);

INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0007,'Xiaomi','Smartphone POCO X5 Pro 5G Black 8GB256GB', 1600, 500 ,0004, 0002);
INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0008,'Samsung','Smartphone Galaxy A54 128GB 6GB 5G', 1400, 550 ,0004, 0002);
INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0009,'Realme','Smartphone Realme C55 256GB 8GB Ram 64Mpx Negro', 1000, 600 ,0004, 0002); #-25%
INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0010,'Apple','Smartphone Apple iPhone 12 - 64GB - Negro', 4900, 400 ,0004, 0002); #-47%
INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0011,'Motorola','Smartphone Motorola Moto E30 32GB 2GB GRIS', 5900, 550 ,0004, 0002); #-27%
...
INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0013,'Asus Nvidia', 'Tarjeta de video ASUS NVIDIA GeForce RTX 3080 Ti, 12GB GDDR6X, PCI-E',14700 , 50 ,5, 0004);
INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0014,'Acer', 'Laptop Acer Aspire 3 AMD Ryzen 5 Serie 7520U 8GB RAM 256GB SSD 15.6"',2600 , 100 ,5, 0004);
INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0015,'Teros', 'Monitor TEROS 21.5 75hz IPS FULL HD 5MS HDMI VGA Monitor GAMING GAMER',699 , 92 ,0005, 0004);
INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0016,'Razer', 'Teclado Razer Blackwidow V3 Tenkeyless Mechanical español',475 , 120 ,0005, 0004);
INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0017,'Epson', 'IMPRESORA MULTIFUNCIONAL EPSON ECOTANK L5590 USBLANWI-FI',1999 , 70 ,0005, 0004);
INSERT INTO producto(id_prod, nombre_prod, descripcion_prod, precio_prod, stock_prod, id_ven, id_categ) VALUES (0018,'Kingston','MEMORIA USB 3.2 KINGSTON EXODIA 128 GB NEGRO',90 , 120 ,0005, 0004);
...
UPDATE producto SET urlImage = 'https://mercury.vtexassets.com/arquivos/ids/10425483-1200-1200?v=638042323745800000&width=1200&height=1200&aspect=true' WHERE id_prod = 1;
UPDATE producto SET urlImage = 'https://wongfood.vtexassets.com/arquivos/ids/635836/LG-Refrigeradora-312-Lt-GT32WPPDC-Door-Cooling-1-70676907.jpg?v=638211729690470000' WHERE id_prod = 2;
UPDATE producto SET urlImage = 'https://vicmark.com.pe/wp-content/uploads/2022/12/ERQU40E2HSS.jpg' WHERE id_prod = 3;
UPDATE producto SET urlImage = 'https://falabella.scene7.com/is/image/FalabellaPE/18395008_2?wid=800&hei=800&qlt=70' WHERE id_prod = 4;
UPDATE producto SET urlImage = 'https://falabella.scene7.com/is/image/FalabellaPE/882259102_01?wid=800&hei=800&qlt=70' WHERE id_prod = 5;
UPDATE producto SET urlImage = 'https://s7d2.scene7.com/is/image/TottusPE/42370728_0?wid=1500&hei=1500&qlt=70' WHERE id_prod = 6;
UPDATE producto SET urlImage = 'https://falabella.scene7.com/is/image/FalabellaPE/gsc_118126970_1977318_1?wid=800&hei=800&qlt=70' WHERE id_prod = 7;
UPDATE producto SET urlImage = 'https://promart.vteximg.com.br/arquivos/ids/6998034-1000-1000/image-25ab123bb70f4dfc9e841ec8e397f996.jpg?v=638194270540730000' WHERE id_prod = 8;
UPDATE producto SET urlImage = 'https://falabella.scene7.com/is/image/FalabellaPE/gsc_121698469_3148506_1?wid=800&hei=800&qlt=70' WHERE id_prod = 9;
UPDATE producto SET urlImage = 'https://dcmallio.vtexassets.com/arquivos/ids/326076301-800-800?v=638130440267430000&width=800&height=800&aspect=true' WHERE id_prod = 10;
UPDATE producto SET urlImage = 'https://falabella.scene7.com/is/image/FalabellaPE/gsc_119670984_2435117_1?wid=800&hei=800&qlt=70' WHERE id_prod = 11;
UPDATE producto SET urlImage = 'https://oechsle.vteximg.com.br/arquivos/ids/14058392-1500-1500/image-61bd9aceb99245b7a31c48378a84fbaa.jpg?v=638141011869800000' WHERE id_prod = 12;
UPDATE producto SET urlImage = 'https://mesajil.com/wp-content/uploads/2022/09/27375-2.jpg' WHERE id_prod = 13;
UPDATE producto SET urlImage = 'https://falabella.scene7.com/is/image/FalabellaPE/882863264?wid=1500&hei=1500&qlt=70' WHERE id_prod = 14;
UPDATE producto SET urlImage = 'https://oechsle.vteximg.com.br/arquivos/ids/8140716-1000-1000/image-2356c5ba606647dc985823b4a514829d.jpg?v=637849855655170000' WHERE id_prod = 15;
UPDATE producto SET urlImage = 'https://http2.mlstatic.com/D_NQ_NP_680531-MPE45066108487_032021-O.webp' WHERE id_prod = 16;
UPDATE producto SET urlImage = 'https://falabella.scene7.com/is/image/FalabellaPE/gsc_119241697_2270954_3?wid=800&hei=800&qlt=70' WHERE id_prod = 17;
UPDATE producto SET urlImage = 'https://promart.vteximg.com.br/arquivos/ids/1558755-1000-1000/10051385.jpg?v=637635405763500000' WHERE id_prod = 18;
UPDATE producto SET urlImage = 'https://phantom.pe/media/catalog/product/cache/2d2e350e73065c0f42c90f0a12869353/s/k/skullcandy_indy_evo_negro_1.jpg' WHERE id_prod = 19;
UPDATE producto SET urlImage = 'https://s7d2.scene7.com/is/image/TottusPE/42385273_1?wid=800&hei=800&qlt=70' WHERE id_prod = 20;
UPDATE producto SET urlImage = 'https://casemotions.pe/wp-content/uploads/2021/12/RD3LT_0.jpg' WHERE id_prod = 21;
UPDATE producto SET urlImage = 'https://plazavea.vteximg.com.br/arquivos/ids/25891155-512-512/image-86e4ab170dd848fcbbfd2766eb3cc663.jpg' WHERE id_prod = 22;
UPDATE producto SET urlImage = 'https://falabella.scene7.com/is/image/FalabellaPE/gsc_115217156_1041871_1?wid=800&hei=800&qlt=70' WHERE id_prod = 23;
UPDATE producto SET urlImage = 'https://tiendasishop.com/media/catalog/product/a/i/airpods_pro_2nd_gen_pdp_image_position-2__usen.jpg?optimize=high&bg-color=255,255,255&fit=bounds&height=700&width=700&canvas=700:700' WHERE id_prod = 24;
UPDATE producto SET urlImage = 'https://plazavea.vteximg.com.br/arquivos/ids/733282-512-512/image-144b6e9d156245afb86e9dd13b340a1c.jpg' WHERE id_prod = 25;
UPDATE producto SET urlImage = 'https://gamecentersac.com/wp-content/uploads/2023/02/GC00947-02.jpg' WHERE id_prod = 26;
UPDATE producto SET urlImage = 'https://oechsle.vteximg.com.br/arquivos/ids/5142276-1000-1000/1945860_6.jpg?v=637684989559630000' WHERE id_prod = 27;
UPDATE producto SET urlImage = 'https://falabella.scene7.com/is/image/FalabellaPE/gsc_120963718_2871527_1?wid=800&hei=800&qlt=70' WHERE id_prod = 28;
-- descuento
